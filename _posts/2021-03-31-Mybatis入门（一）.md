...
```
启动项目，发现报错了。
![3MZ41K2}P){WQNBW_B2@ZYY.png](https://www.hualigs.cn/image/6064284b5e426.jpg)
...
![9GFF_DFH1_7__8~N__VY_IQ.png](https://i.loli.net/2021/03/31/42icV5sCIjUkma8.png)
2. 把xml放到resources包下面，同时记得修改Mybatis配置文件的mapper位置
![_G_RS_3_1_2WY_E_6EB0@_G.png](https://i.loli.net/2021/03/31/dyNEIgKeBZo1FOu.png)
OK，发现也能查询出结果。
# 项目改进
接下来我们需要对项目进行改进
